...
namespace site_pessoal_dinamico.Controllers
{
    ...
    public class experiencia_profissionalController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("experiencia_profissionalId,funcao,empresa,descricao_exp,data")] experiencia_profissional experiencia_profissional)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("experiencia_profissionalId,funcao,empresa,descricao_exp,data")] experiencia_profissional experiencia_profissional)
        {
